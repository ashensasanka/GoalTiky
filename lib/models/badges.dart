class Badges {
  ...
  static List<Badges> getFavoritedPlants(){
    List<Badges> _travelList = Badges.badgeList;
    return _travelList.where((element) => element.isFavorated == true).toList();
  }

  //Get the cart items
  static List<Badges> addedToCartPlants(){
    List<Badges> _selectedPlants = Badges.badgeList;
